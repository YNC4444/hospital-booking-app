...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('patients.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="emergency_contact_name" id="emergency_contact_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('emergency_contact_name') }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="emergency_contact_phone" id="emergency_contact_phone" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('emergency_contact_phone') }}" required>
