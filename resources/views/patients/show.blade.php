...
<div class="container mx-auto px-4">
  ...
  <div class="bg-white shadow-md rounded p-6">
    ...
    <div class="flex items-center justify-between">
      ...
      <a href="{{ route('patients.trash', $patient->id) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
        Delete
      </a>
    </div>
  </div>
